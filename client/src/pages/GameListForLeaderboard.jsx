...
function GameCard({ game, setSelectedGame, selectedGame }) {
    ...
    return (
        <div className={`flex flex-col p-3 w-36 h-36 bg-slate-700 dark:bg-dark-secondary rounded-lg cursor-pointer sm:w-60 sm:h-60 shadow-cyan-400/60 transition-shadow ${isSelectedGame && "shadow-lg"}`} onClick={handleGameSelect}>
