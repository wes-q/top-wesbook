    ...
    const handleImageUpload = async (event) => {
        ...
        if (confirm(text) === true) {
            ...
            try {
                ...
                const response = await axios.post(`${import.meta.env.VITE_SERVER_URL}/api/uploadImage`, form);
    ...
    const handleImageRemove = async () => {
        ...
        if (confirm(text) === true) {
            ...
            try {
                ...
                //     const response = await axios.post(`${import.meta.env.VITE_SERVER_URL}/api/profile-delete`, { filePath: filePath });
