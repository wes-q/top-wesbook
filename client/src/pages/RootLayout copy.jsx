            ...
            <header>
                <nav className="w-full sm:justify-between sm:items-center p-3 sm:p-6 bg-gray-800 specific text-base sm:text-lg">
                    ...
                    <AnimatePresence>
                        {isExpanded && (
                            <motion.div
                                className="absolute z-30 flex flex-col sm:hidden sm:flex-row sm:justify-center sm:items-center sm:gap-10 bg-white"
                            ...
                            >
                                ...
                                <NavLink className="text-cyan-400 bg-red-800 rounded-md px-4 py-1 whitespace-nowrap" to="/">
                                    Newsfeed
                                </NavLink>
                                {/* <NavLink className="text-cyan-400 bg-gray-800 rounded-md px-4 py-1 whitespace-nowrap" to={`/profile/${user.id}`}>
                                Profile Page
