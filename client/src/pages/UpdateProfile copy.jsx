            ...
            <div className="flex flex-col sm:flex-row justify-center sm:gap-12">
                ...
                <form className="sm:w-[400px] h-auto" onSubmit={handleSubmit}>
                    ...
                    <label>
                        ...
                        <div className="relative">
                            <input type="text" name="bio" value={formData.bio || ""} onChange={handleChange} className="mt-1 mb-2 px-3 py-2 bg-white text-black border-2 shadow-sm border-slate-300 placeholder-slate-400 focus:outline-none focus:border-sky-500 focus:ring-sky-500 block w-full rounded-md sm:text-sm focus:ring-1  valid:border-green-400 disabled:bg-gray-300 disabled:text-gray-500 disabled:border-gray-300" placeholder="John Wick" autoComplete="displayName" required autoFocus pattern=".*\S+.*" title="Display name is required" disabled={bioDisabled} spellCheck="false" />
                            <button type="button" className="absolute top-[9px] right-4 text-sm text-gray-600 hover:text-cyan-600" onClick={() => setBioDisabled(false)}>
                                Change
                            </button>
                        </div>
                    </label>
                    ...
                    <label>
                        ...
                        <div className="relative">
                            <input type="text" name="gender" value={formData.gender || ""} onChange={handleChange} className="mt-1 mb-2 px-3 py-2 bg-white text-black border-2 shadow-sm border-slate-300 placeholder-slate-400 focus:outline-none focus:border-sky-500 focus:ring-sky-500 block w-full rounded-md sm:text-sm focus:ring-1  valid:border-green-400 disabled:bg-gray-300 disabled:text-gray-500 disabled:border-gray-300" placeholder="John Wick" autoComplete="displayName" required autoFocus pattern=".*\S+.*" title="Display name is required" disabled={genderDisabled} spellCheck="false" />
                            <button type="button" className="absolute top-[9px] right-4 text-sm text-gray-600 hover:text-cyan-600" onClick={() => setGenderDisabled(false)}>
                                Change
                            </button>
                        </div>
                    </label>
